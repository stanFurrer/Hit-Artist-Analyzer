...
function display_song(file, color) {
  console.log("CACA")
	d3.csv(file,function(data) {
		    svg
		      .append("path")
...
display_conf_interval("/data/Michael Jackson_mean_std.csv", colors[0])
display_conf_interval("/data/Frank Sinatra_mean_std.csv", colors[2])
display_song("/data/mj_quincy.csv", colors[5])
display_song("/data/sinatra_quincy.csv", colors[4])
